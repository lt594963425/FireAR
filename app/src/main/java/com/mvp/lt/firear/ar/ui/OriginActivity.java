...
import com.mvp.lt.firear.control.XFVoiceController;
import com.mvp.lt.firear.model.GeoPoint;
import com.mvp.lt.firear.model.PoiSearchData;
...
public abstract class OriginActivity extends FragmentActivity implements
	...
	public void startActivity(Class<? extends Activity> activity) {
		Intent intent = new Intent(AppManager.getInstance(), activity);
