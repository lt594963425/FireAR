...
public class MInfowindow implements InfoWindowAdapter {
    ...
    private TextView mInfoCallNumber;
    private ImageView mInfoCallImage;
    ...
    private void init() {
        ...
        //拨号
        mInfoCallNumber = mWindow.findViewById(R.id.info_call_number);
        mInfoCallImage = mWindow.findViewById(R.id.info_call_image);
        mInfoCallImage.setOnClickListener(new OnClickListener() {
            @Override
