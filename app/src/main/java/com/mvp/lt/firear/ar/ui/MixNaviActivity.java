...
import com.mvp.lt.firear.ar.util.ARNaviMarker;
import com.mvp.lt.firear.control.AMapNaviController;
import com.mvp.lt.firear.util.GeoCalcUtil;
import com.mvp.lt.firear.util.TimerUtil;
...
import static com.mvp.lt.firear.Constants.EVENT_ACTIVITY_FINISH_MAP_NAVI;
import static com.mvp.lt.firear.Constants.EVENT_NAVI_RECALCUL_ROUTE;
import static com.mvp.lt.firear.Constants.IS_DEBUG;
import static com.mvp.lt.firear.Constants.NAVI_MODE_EMULATOR;
import static com.mvp.lt.firear.Constants.NAVI_MODE_GPS;
...
public class MixNaviActivity extends ARNaviActivity implements
		AMapNaviController.OnNavingListener, OnClickListener, OnSweetClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 导航控制
		mMapNaviController = new AMapNaviController(AppManager.getInstance());
		// 监听导航信息回调
		...
		// 准备导航
		mMapNaviController.preNavi(AppManager.getInstance(), mNaviMode);
