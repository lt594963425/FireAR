package com.mvp.lt.firear.view;
...
import static com.mvp.lt.firear.Constants.KEY_ITEM_LABEL_IMG;
import static com.mvp.lt.firear.Constants.KEY_ITEM_LABLE_NAME;
...
public class MaterialDrawerLayout extends DrawerLayout implements
    ...
    private void initView() {
        mMaterialBtn = mtitlebar.findViewById(R.id.id_materialmenu_btn);
        mMoreBtn = mtitlebar.findViewById(R.id.id_rippleLayout_titleBar_moreBtn);
        mDrawerListView = findViewById(R.id.id_listView_drawer);
