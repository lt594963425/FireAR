...
import static com.mvp.lt.firear.Constants.ID_APP_XFVoice;
...
public class XFVoiceController {
    ...
    public void startListeningByDialog(Context context) {
        ...
        Log.e("TAG", "startListeningByDialog");
        mDialog.show();
        setLinkText(mDialog);
    }

    private void setLinkText(RecognizerDialog mDialog) {
        //获取字体所在的控件，设置为"",隐藏字体，
    ...
    private class STTUnit implements RecognizerListener,
        ...
        private void initSetting() {
            ...
            mStt = SpeechRecognizer.createRecognizer(mContext, mInitListener);
            // 参数设置
